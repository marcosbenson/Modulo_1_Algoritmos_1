public class SE_EnemigoAereo extends SE_Enemigo {

  private static final String[] SPRITES = { "SeaHarrier", "WestlandLynx", "SeaKing" };

  public SE_EnemigoAereo(SE_GestorDeEntidades gestor, float x, float y) {
